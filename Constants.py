...
X_MATRIX_PARENT_DIR = f"{OUTPUT_DIR}{PATH_SEP}{X_MATRIX_TOP_DIR}{PATH_SEP}"
X_MATRIX_FILEPATH_NO_NORMALIZATION = \
    f"{X_MATRIX_PARENT_DIR}{X_MATRIX_SUB_DIR_DICT[XMatrixOptionEnum.NO_NORMALIZATION]}{PATH_SEP}{X_MATRIX_FILENAME}"
X_MATRIX_FILEPATH_X_NORMALIZATION = \
    f"{X_MATRIX_PARENT_DIR}{X_MATRIX_SUB_DIR_DICT[XMatrixOptionEnum.X_NORMALIZATION]}{PATH_SEP}{X_MATRIX_FILENAME}"
