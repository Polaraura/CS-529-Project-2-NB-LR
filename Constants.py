...
from utilities.ParseUtilities import create_sub_directories
...
X_MATRIX_FILEPATH_NO_NORMALIZATION_TRAINING = \
    f"{X_MATRIX_PARENT_DIR_TRAINING}{X_MATRIX_SUB_DIR_DICT[XMatrixOptionEnum.NO_NORMALIZATION]}{PATH_SEP}{X_MATRIX_FILENAME}"
X_MATRIX_FILEPATH_X_NORMALIZATION_TRAINING = \
    f"{X_MATRIX_PARENT_DIR_TRAINING}{X_MATRIX_SUB_DIR_DICT[XMatrixOptionEnum.X_NORMALIZATION]}{PATH_SEP}{X_MATRIX_FILENAME}"

# Validation
X_MATRIX_PARENT_DIR_VALIDATION = f"{OUTPUT_DIR}{PATH_SEP}{X_MATRIX_TOP_DIR_VALIDATION}{PATH_SEP}"
X_MATRIX_FILEPATH_NO_NORMALIZATION_VALIDATION = \
    f"{X_MATRIX_PARENT_DIR_VALIDATION}{X_MATRIX_SUB_DIR_DICT[XMatrixOptionEnum.NO_NORMALIZATION]}{PATH_SEP}{X_MATRIX_FILENAME}"
X_MATRIX_FILEPATH_X_NORMALIZATION_VALIDATION = \
    f"{X_MATRIX_PARENT_DIR_VALIDATION}{X_MATRIX_SUB_DIR_DICT[XMatrixOptionEnum.X_NORMALIZATION]}{PATH_SEP}{X_MATRIX_FILENAME}"
